---
lab:
  title: Análisis de la privacidad diferencial
ms.openlocfilehash: b0c369d3c6405fa3990596a738962115e6889ec2
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: es-ES
ms.lasthandoff: 11/17/2021
ms.locfileid: "132832652"
---
# <a name="explore-differential-privacy"></a>Análisis de la privacidad diferencial

A menudo, los datos usados para entrenar modelos de aprendizaje automático contienen valores confidenciales que se deben mantener privados. La privacidad diferencial es una técnica en la que se agrega "ruido" a los datos de forma que las medidas estadísticas y las agregaciones sigan siendo coherentes con los datos de origen sin procesar, pero es más difícil identificar valores para observaciones individuales.
...
## <a name="use-smartnoise-to-explore-differential-privacy"></a>Usar SmartNoise para explorar la privacidad diferencial

En este ejercicio, se proporciona código para explorar la privacidad diferencial con SmartNoise en un cuaderno.

1. En la página principal de Jupyter, vaya a la carpeta **/users/*su-nombre-de-usuario*/mslearn-dp100** donde clonó el repositorio de cuadernos y abra el cuaderno **Análisis de la privacidad diferencial**.
