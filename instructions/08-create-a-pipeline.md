---
lab:
  title: Crear una canalización
ms.openlocfilehash: d76c9c66876fcb03aa02d48ee47ae92e327dd8c9
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: es-ES
ms.lasthandoff: 11/17/2021
ms.locfileid: "132832659"
---
# <a name="create-a-pipeline"></a>Crear una canalización

Puede usar el SDK de Azure Machine Learning para realizar todas las tareas necesarias para crear y ejecutar una solución de aprendizaje automático en Azure. En lugar de realizar estas tareas individualmente, puede usar *canalizaciones* para organizar los pasos necesarios para preparar los datos, ejecutar scripts de entrenamiento, registrar modelos y otras tareas.
...
## <a name="create-and-publish-a-pipeline"></a>Crear y publicar una canalización

En este ejercicio, el código para crear y publicar una canalización se proporciona en un cuaderno.

1. En la página principal de Jupyter, vaya a la carpeta **/users/*su-nombre-de-usuario*/mslearn-dp100** donde clonó el repositorio de cuadernos y abra el cuaderno **Crear una canalización**.
