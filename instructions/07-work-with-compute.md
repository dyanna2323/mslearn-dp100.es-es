---
lab:
  title: Trabajar con procesos
ms.openlocfilehash: 7f20c3ac54bd6dd770c9874cf4e9f9f96d5924f0
ms.sourcegitcommit: 18f734eeb1031a9cb69c3b294632efd2e69324ac
ms.translationtype: HT
ms.contentlocale: es-ES
ms.lasthandoff: 11/17/2021
ms.locfileid: "132832676"
---
# <a name="work-with-compute"></a>Trabajar con procesos

Todo el código de Python se ejecuta en el contexto de un entorno, lo que determina los paquetes de Python que están disponibles. El código se puede ejecutar en un entorno en la estación de trabajo local o en algún otro destino de proceso; por ejemplo, un clúster para aumentar la escalabilidad.

En este ejercicio, explorará *entornos* y *destinos de proceso*, que puede usar para ejecutar experimentos en Azure Machine Learning.
...
## <a name="work-with-environments-and-compute-targets"></a>Trabajar con entornos y destinos de proceso

En este ejercicio, el código para trabajar con el proceso se proporciona en un cuaderno.

1. En la página principal de Jupyter, vaya a la carpeta **/users/*su-nombre-de-usuario*/mslearn-dp100** donde clonó el repositorio de cuadernos y abra el cuaderno **Trabajar con procesos**.
